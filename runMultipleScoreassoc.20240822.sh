...
# example usage:
# dx cd / ; dx run swiss-army-knife -y --ignore-reuse --instance-type mem3_hdd2_v2_x4  -imount_inputs=FALSE -iin="/scripts/runScoreassoc.20240815.sh" -icmd="bash runScoreassoc.20240815.sh $model for.$model.lst  runTests.sh"
